...
class _$_RegisterObject implements _RegisterObject {
  ...
  @override
  String toString() {
    return 'RegisterObject(userName: $userName, countryMobileCode: $countryMobileCode, mobileNumber: $mobileNumber, profilePicture: $profilePicture, email: $email, password: $password)';
  }
